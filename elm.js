...
var $author$project$Data$Employee = F5(
	function (firstName, lastName, middleName, pin, jobRoles) {
		return {firstName: firstName, jobRoles: jobRoles, lastName: lastName, middleName: middleName, pin: pin};
	});
...
var $author$project$Data$decodeEmployee = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Data$Employee,
	...
	A2($elm$json$Json$Decode$field, 'middlename', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'pin', $elm$json$Json$Decode$int),
	A2(
		$elm$json$Json$Decode$field,
		'jobroles',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Data$JobRole = F2(
	function (name, doesCashOut) {
		return {doesCashOut: doesCashOut, name: name};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Data$decodeJobRole = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Data$JobRole,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'doesCashOut', $elm$json$Json$Decode$bool));
				...
				[
					$elm$http$Http$get(
					{
						expect: A2(
							...
							$author$project$Main$GotEmployees,
							$elm$json$Json$Decode$list($author$project$Data$decodeEmployee)),
	...
	function (msg, model) {
		switch (msg.$) {
			case 'UpdatePin':
				var pin = msg.a;
				return _Utils_Tuple2(
					($elm$core$String$length(pin) <= 4) ? _Utils_update(
						model,
						{
							employee: $elm$core$List$head(
								A2(
									$elm$core$List$filter,
									function (t) {
										return _Utils_eq(
											$elm$core$Maybe$Just(t.pin),
											$elm$core$String$toInt(pin));
									},
									model.employees)),
							pin: pin
						}) : model,
			...
			case 'UpdateJobRole':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							jobRole: $elm$core$Maybe$Just(jobRole)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateCashCollected':
				var cashCollected = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'NewTime':
				var now = msg.a;
				var posix = function () {
					var _v1 = model.clockedInPosix;
					if (_v1.$ === 'Just') {
						var clockedInPosix = _v1.a;
						return clockedInPosix;
					} else {
						return now;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							clockedInPosix: $elm$core$Maybe$Just(posix)
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
										...
										$elm$json$Json$Encode$object(
											_List_fromArray(
												[
													_Utils_Tuple2(
													'pin',
													$elm$json$Json$Encode$string(model.pin)),
													_Utils_Tuple2(
													'clockedInAt',
													$elm$json$Json$Encode$int(
														$elm$time$Time$posixToMillis(posix)))
												]))),
									expect: $elm$http$Http$expectString($author$project$Main$ClockedIn),
	...
	return A2(
			...
			]),
		{
			label: A2(
				...
				$mdgriffith$elm_ui$Element$text('Cash Collected')),
			onChange: $author$project$Main$UpdateCashCollected,
...
var $author$project$Main$ClockInClockOut = {$: 'ClockInClockOut'};
...
var $author$project$Main$clockInClockOutText = function (clockedInPosix) {
	if (clockedInPosix.$ === 'Just') {
		return 'Clock Out';
	} else {
		return 'Clock In';
	}
...
var $author$project$Main$clockInOutButton = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$rounded(3),
				$mdgriffith$elm_ui$Element$Border$color($author$project$Main$grey),
				$mdgriffith$elm_ui$Element$Border$width(1),
			...
			]),
		{
			label: $mdgriffith$elm_ui$Element$text(
				$author$project$Main$clockInClockOutText(model.clockedInPosix)),
			onPress: $elm$core$Maybe$Just($author$project$Main$ClockInClockOut)
		});
};
...
var $author$project$Data$getEmployeeJobRoles = F2(
	function (employee, jobRoles) {
		return A2(
			$elm$core$List$filter,
			function (jobRole) {
				return A2(
					$elm$core$List$any,
					function (t) {
						return _Utils_eq(jobRole.name, t);
					},
					employee.jobRoles);
			},
			jobRoles);
...
var $author$project$Main$toInputOption = function (jobRole) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$option,
		jobRole,
		$mdgriffith$elm_ui$Element$text(jobRole.name));
};
var $author$project$Main$positionSelect = function (model) {
	var jobRoles = function () {
		var _v0 = model.employee;
		if (_v0.$ === 'Just') {
			var employee = _v0.a;
			return A2($author$project$Data$getEmployeeJobRoles, employee, model.jobRoles);
		} else {
			return _List_Nil;
		}
	}();
	return A2(
			...
			]),
		{
			label: A2(
				...
				$mdgriffith$elm_ui$Element$text('Please select a position')),
			onChange: $author$project$Main$UpdateJobRole,
			options: A2($elm$core$List$map, $author$project$Main$toInputOption, jobRoles),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					{bottom: 10, left: 10, right: 10, top: 100})
				]),
			_List_fromArray(
				[
					A2(
					...
					if (_v0.$ === 'Just') {
						var jobRole = _v0.a;
						return jobRole.doesCashOut ? A2(
							$author$project$Main$showIfPin,
							showSecureSection,
							$author$project$Main$cashInput(model)) : A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									A2($mdgriffith$elm_ui$Element$paddingXY, 0, 12),
					...
					$author$project$Main$showIfPin,
					showSecureSection,
					$author$project$Main$clockInOutButton(model))
				])));
};
