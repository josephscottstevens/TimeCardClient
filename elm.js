...
var author$project$Main$init = function (timeEntries) {
	return _Utils_Tuple2(
		{cashCollected: '', clockedInPosix: elm$core$Maybe$Nothing, employee: elm$core$Maybe$Nothing, jobRole: elm$core$Maybe$Nothing, pin: '', timeEntries: _List_Nil},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$SetTimeEntries = function (a) {
	return {$: 'SetTimeEntries', a: a};
};
...
var author$project$Main$timeEntriesUpdated = _Platform_incomingPort(
	'timeEntriesUpdated',
...
var author$project$Main$addTimeEntry = _Platform_outgoingPort(
	'addTimeEntry',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var author$project$Main$temporaryClockedInMsg = _Platform_outgoingPort('temporaryClockedInMsg', elm$json$Json$Encode$string);
var author$project$TimeEntry$TimeEntry = F3(
...
var author$project$JobRole$JobRole = F2(
...
var author$project$Employee$all = _List_fromArray(
	[
		{
		firstName: 'Gary',
		jobRoles: _List_fromArray(
			[author$project$JobRole$generalManager, author$project$JobRole$lineCook, author$project$JobRole$server]),
		lastName: 'Truong',
		middleName: '',
		pin: '1234'
	},
...
var author$project$Employee$getJobRoles = function (pin) {
	return A2(
		...
		A2(
			...
			elm$core$List$head(
				A2(
					...
					function (t) {
						return _Utils_eq(t.pin, pin);
					},
					author$project$Employee$all))));
};
...
var author$project$Main$grey = A3(mdgriffith$elm_ui$Element$rgb, 0.9, 0.9, 0.9);
...
var author$project$Main$pinErrorMessage = function (pin) {
	return ((elm$core$String$length(pin) === 4) && (!elm$core$List$length(
		author$project$Employee$getJobRoles(pin)))) ? 'Invalid Pin, please contact your manager' : '';
};
...
var author$project$Main$toInputOption = function (jobRole) {
	return A2(
		mdgriffith$elm_ui$Element$Input$option,
		jobRole,
		mdgriffith$elm_ui$Element$text(jobRole.description));
};
...
var author$project$Main$positionSelect = function (model) {
	return A2(
			...
			]),
		{
			...
			options: A2(
				elm$core$List$map,
				author$project$Main$toInputOption,
				author$project$Employee$getJobRoles(model.pin)),
...
var author$project$Main$view = function (model) {
	var showSecureSection = elm$core$List$length(
		author$project$Employee$getJobRoles(model.pin)) > 0;
	return A2(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								mdgriffith$elm_ui$Element$text(
									author$project$Main$pinErrorMessage(model.pin))))
						]),
					{
						label: A2(
							mdgriffith$elm_ui$Element$Input$labelAbove,
